...
const TokenUsageTab: React.FC<TokenUsageTabProps> = ({ projectPath }) => {
  ...
  }, [projectPath, paginationModel.page, paginationModel.pageSize]);
  ...
  const loadUsageData = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/projects/${projectPath}/token-usage`,
        {
          params: {
  ...
  const loadStats = async () => {
    try {
      const response = await axios.get(
        `${API_URL}/api/projects/${projectPath}/token-usage/stats`
      );
